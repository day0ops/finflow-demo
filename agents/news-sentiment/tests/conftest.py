...
# Add news-mcp to path so tests can import its FastMCP instance.
...
MCP_PATH = os.path.join(REPO_ROOT, "mcp-servers", "news-mcp")
...
# After this, sys.modules["server"] == news-mcp/server.py.
_mcp_server = importlib.import_module("server")  # resolves to news-mcp/server.py
