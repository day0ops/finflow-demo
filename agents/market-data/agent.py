...
from tools import get_historical, get_price, get_sector_performance
...
_root_agent = Agent(
    ...
    instruction=(
        ...
        "Use get_price for current prices, get_historical for price history, "
        "and get_sector_performance for sector breakdown. "
        "Always use tools — never invent prices or data."
    ),
    tools=[get_price, get_historical, get_sector_performance],
)
