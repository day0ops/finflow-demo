...
MCP_PATH = os.path.join(REPO_ROOT, "mcp-servers", "market-data-mcp")
...
# After this, sys.modules["server"] == market-data-mcp/server.py.
_mcp_server = importlib.import_module("server")  # resolves to market-data-mcp/server.py
