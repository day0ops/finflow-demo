...
# Add portfolio-mcp to path so tests can import its FastMCP instance.
...
MCP_PATH = os.path.join(REPO_ROOT, "mcp-servers", "portfolio-mcp")
...
# After this, sys.modules["server"] == portfolio-mcp/server.py.
_mcp_server = importlib.import_module("server")  # resolves to portfolio-mcp/server.py
